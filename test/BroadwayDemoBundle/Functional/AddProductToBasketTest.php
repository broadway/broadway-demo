...
namespace BroadwayDemoBundle\Functional;
...
class AddProductToBasketTest extends WebTestCase
{
    ...
    public function it_adds_a_product_to_the_basket()
    {
        ...
        $response = $this->post('/basket/' . $basketId . '/addProduct', array('productId' => '4d4ceed3-0aed-46f4-a86f-ca78ba5ea5db', 'productName' => 'ThisProductRocks'));
    }
    ...
    public function it_removes_a_product_from_the_basket()
    {
        ...
        $response = $this->post('/basket/' . $basketId . '/addProduct', array('productId' => '4d4ceed3-0aed-46f4-a86f-ca78ba5ea5db', 'productName' => 'ThisProductRocks'));
        $response = $this->post('/basket/' . $basketId . '/removeProduct', array('productId' => '4d4ceed3-0aed-46f4-a86f-ca78ba5ea5db', 'productName' => 'ThisProductRocks'));
    }
    ...
    public function it_exposes_and_advice_after_checking_out_a_basket()
    {
        ...
        $response = $this->post('/basket/' . $basketId . '/addProduct', array('productId' => $firstProductId, 'productName' => 'ThisProductRocks'));
        $response = $this->post('/basket/' . $basketId . '/addProduct', array('productId' => $secondProductId, 'productName' => 'ThisProductRocks'));
        $response = $this->post('/basket/' . $basketId . '/addProduct', array('productId' => $secondProductId, 'productName' => 'ThisProductRocks'));
        $response = $this->post('/basket/' . $basketId . '/addProduct', array('productId' => $thirdProductId, 'productName' => 'ThisProductRocks'));
